...
const descriptionStr = `A total of $${totalRaisedAll.toLocaleString(
  "en-US"
)} has been raised for ${totalGamesCount.toLocaleString("en-US")} ${
  totalGamesCount === 1 ? "game" : "games"
}. Currently, ${unfundedCount.toLocaleString("en-US")} ${
  unfundedCount === 1 ? "game remains" : "games remain"
} unfunded. We need your help to fund these amazing games!`

// create a new DOM element containing the template string and append it to the description container
const p = document.createElement("p")
p.innerHTML = descriptionStr
